 ...
 */
class Admin extends \RecrutementTest\RecrutementTestBundle\Entity\Admin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'tests', 'nom', 'password', 'actif');
        }
